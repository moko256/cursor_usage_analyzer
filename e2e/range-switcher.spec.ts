...
test('range switcher filters charts without changing usage totals', async ({ page }) => {
	...
	await expect(day30).toHaveClass(/\boutline\b/);
	await expect(day30).not.toHaveClass(/\bsecondary\b/);
	await expect(day1).toHaveClass(/\boutline\b/);
	await expect(day1).toHaveClass(/\bsecondary\b/);
	await expect(day7).toHaveClass(/\boutline\b/);
	await expect(day7).toHaveClass(/\bsecondary\b/);
	...
	await day7.click();
	await expect(day7).toHaveClass(/\boutline\b/);
	await expect(day7).not.toHaveClass(/\bsecondary\b/);
	await expect(day1).toHaveClass(/\boutline\b/);
	await expect(day1).toHaveClass(/\bsecondary\b/);
	await expect(day30).toHaveClass(/\boutline\b/);
	await expect(day30).toHaveClass(/\bsecondary\b/);
	...
	await day1.click();
	await expect(day1).toHaveClass(/\boutline\b/);
	await expect(day1).not.toHaveClass(/\bsecondary\b/);
	await expect(day7).toHaveClass(/\boutline\b/);
	await expect(day7).toHaveClass(/\bsecondary\b/);
	await expect(day30).toHaveClass(/\boutline\b/);
	await expect(day30).toHaveClass(/\bsecondary\b/);
